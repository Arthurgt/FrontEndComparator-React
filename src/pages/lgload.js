...
import './load.scss';
import GameLargeComponent from '../components/GameLargeComponent';

class Lgload extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
      ...
      componentDidMount() {
        this.setState({componentRenderTime: window.performance.now('Lgload')});
